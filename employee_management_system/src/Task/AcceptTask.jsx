...
const AcceptTask = () => {
    return (
        <div className='flex-shrink-0 py-4 h-full w-[300px] bg-purple-600 rounded-lg'>
            ...
            <div className='flex justify-between items-center px-3 mt-2'>
                <button className='bg-green-500 text-white px-4 py-2 rounded-md mr-2'>Completed</button>
